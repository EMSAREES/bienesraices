...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == 'POST'){
        ...
        if(empty($errores)){
            ...
            $query = "INSERT INTO propiedades (titulo,precio,descripcion,habitaciones,wc,estacionamiento,vendedor_id,creado, imagen) 
                    value('$titulo','$precio','$descripcion','$habitaciones','$wc','$estacionamiento','$vendedor_id', '$creado', '$nombreImagen')";
